...
public class TransactionServiceImpl implements TransactionService {
	...
	public String proceedUnchecked(String username, TransactionDetails details) {
		...
		if (!checkActualityOfPrices(details, currentPrices)) {
			...
			switch(details.getTransactionType()) {
				case BUY: return proceedPurchase(username, details);
				case SELL: return proceedSale(username, details);
			}
		}
	...
	private boolean checkActualityOfPrices(TransactionDetails details, Prices prices) {
		return prices.getFor(details.getTransactionType()).equals(details.getUnitPrice());
	}
